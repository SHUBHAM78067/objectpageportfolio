		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Portfolio Fiori",
									"targetURL": "#PortfolioFioriobjectpageportfolio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PortfolioFioriobjectpageportfolio-display": {
								"semanticObject": "PortfolioFioriobjectpageportfolio",
								"action": "display",
								"description": "ObjectPageFioriPortfolio",
								"title": "Portfolio Fiori",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=PortfolioFiori.objectpageportfolio",
									"url": sap.ui.require.toUrl("PortfolioFiori/objectpageportfolio")
								}
							}
						}
					}
